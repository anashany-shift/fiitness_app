...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/chatImage.png
  AssetGenImage get chatImage =>
      const AssetGenImage('assets/icons/chatImage.png');

  /// File path: assets/icons/clickedFemale.png
  AssetGenImage get clickedFemale =>
      const AssetGenImage('assets/icons/clickedFemale.png');

  /// File path: assets/icons/clickedMale.png
  AssetGenImage get clickedMale =>
      const AssetGenImage('assets/icons/clickedMale.png');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/bg_onBoarding.jpg
