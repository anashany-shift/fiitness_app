...
class _FoodApiCLient implements FoodApiCLient {
  ...
  @override
  Future<MealsDetailsResponse> getMealDetails(String mealId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'i': mealId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MealsDetailsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'lookup.php',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MealsDetailsResponse _value;
    try {
      _value = MealsDetailsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
